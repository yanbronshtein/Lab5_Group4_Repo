/**
 * This Class implements Navigation
 * @name Navigation.java */
...
public class Navigation {
	...
	/**
	 * This method takes (x,y) coordinates of desired point, calculates the min angle need for robot
	 * to rotate to so that the robot can go in a straight line towards the coordinate
	 * @param x 
	 * @param y
	 * @returns
	 */
	...
	/**
	 * This method calculates the min angle required for robot to turn to desired angle and orients the robot
	 *@param theta
	 *@returns
	 *  */
	...
	/*Method determines if robot is moving by checking if either one of the motors is moving
	 * @returns boolean val   */
